  ...
  async (req: AuthRequest, res: Response) => {
    ...
    try {
      ...
      const insertResult = await pool.query(
        `INSERT INTO api_keys (workspace_id, api_id, name, key_hash, key_prefix, encrypted_key, environment)
       VALUES ($1, $2, $3, $4, $5, $6, $7)
       RETURNING id, workspace_id, api_id, name, key_prefix, environment, created_at`,
        [workspaceId, id, name, keyHash, keyPrefix, encrypt(rawKey), environment || 'production']
      );

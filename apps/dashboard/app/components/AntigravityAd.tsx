...
export default function AntigravityAd() {
  ...
  useGSAP(
    () => {
      ...
      tl.to(
        '.ag-world',
        { rotationX: 60, rotationZ: -45, scale: 0.8, y: 50, duration: 2, ease: 'power4.inOut' },
        'scene2'
      );
      ...
      tl.to(
        '.ag-node.upstream',
        { z: 40, duration: 1.5, stagger: 0.1, ease: 'power3.out' },
        'scene2+=1.2'
      );

      // Add idle floating animations (yoyo)
      gsap.to('.ag-node.gateway', {
        z: 95,
        duration: 3,
        yoyo: true,
        repeat: -1,
      ...
      tl.to(
        '.ag-auth-panel',
        { opacity: 1, scale: 1, z: 200, duration: 1.5, ease: 'back.out(1.2)' },
        'scene3'
      );
      gsap.to('.ag-auth-panel', {
        z: 220,
        duration: 4,
        yoyo: true,
        repeat: -1,
      ...
      tl.to(
        '.ag-particle.p1',
        { x: 300, y: -200, z: 40, duration: 1.2, ease: 'power2.inOut' },
        'scene4'
      );
      ...
      tl.to(
        '.ag-world',
        { rotationZ: -15, rotationX: 50, scale: 0.9, x: -100, duration: 4, ease: 'sine.inOut' },
        'scene5'
      );
  ...
  return (
    ...
    >
      ...
      <div className="ag-world ag-centered">
        ...
        <div
          className="ag-title absolute top-[10%] left-0 right-0 text-center text-4xl font-medium tracking-wide text-white drop-shadow-2xl z-50"
        ...
        <div className="ag-centered ag-node gateway glass-panel absolute w-64 h-64 flex flex-col items-center justify-center">
          <div className="font-pixel text-4xl mb-3 text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">
            RELAY_
          </div>
          <div className="font-mono text-xs text-[#a1a1aa] tracking-[0.2em] bg-black/40 px-3 py-1 rounded border border-white/5">
            GATEWAY
          </div>
      ...
      <div className="ag-brand-frame absolute inset-0 flex items-center justify-center z-50">
        ...
        <div className="relative text-center z-10">
          <div className="ag-brand-logo font-pixel text-8xl text-white mb-6 drop-shadow-[0_0_40px_rgba(255,255,255,0.3)]">
            RELAY_
          </div>
          <div className="text-xl font-mono text-[#a1a1aa] tracking-widest uppercase mb-10">

    ...
    try {
      ...
      const res = await fetch('/api/proxy-test', {
        ...
        body: JSON.stringify({
          ...
          headers,
          body:
            ['POST', 'PUT', 'PATCH', 'DELETE'].includes(method) && reqBody.trim()
              ? reqBody
              : undefined,
        }),
      });
      ...
      <div style={{ display: 'grid', gap: '24px', gridTemplateColumns: '1fr 1.5fr' }}>
        <div>
          ...
          <div className="field">
            ...
            <input
              ...
              placeholder="rly_live_..."
            />
            <div className="hint" style={{ marginTop: '8px' }}>
              Paste the raw key you generated earlier.
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            {response && (
              <div style={{ display: 'flex', gap: '16px', fontSize: '12px' }}>
                <span
                  className={
                    response.status >= 400 || response.status === 'Error' ? 'red' : 'green'
                  }
                >
          ...
          <div style={{ padding: '16px', flex: 1, overflowY: 'auto' }}>
            {!response && !loading && (
              <span className="c-secondary" style={{ fontSize: '13px' }}>

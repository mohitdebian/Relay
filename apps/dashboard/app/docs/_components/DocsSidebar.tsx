      ...
      <nav className="sidebar-nav">
        <div className="nav-group">
          ...
          <Link
            ...
            className={`nav-item${isActive('/docs/authentication')}`}
          >
            Authentication
          </Link>
        ...
        <div className="nav-group">
          ...
          <Link
            ...
            className={`nav-item method${isActive('/docs/api-keys/create')}`}
          >
            <span className="m-tag post">POST</span>Create API key
          </Link>
          <Link
            href="/docs/api-keys/list"
            className={`nav-item method${isActive('/docs/api-keys/list')}`}
          >
            <span className="m-tag get">GET</span>List API keys
          </Link>
          <Link
            href="/docs/api-keys/revoke"
            className={`nav-item method${isActive('/docs/api-keys/revoke')}`}
          >
        ...
        <div className="nav-group">
          ...
          <Link
            href="/docs/apis/create"
            className={`nav-item method${isActive('/docs/apis/create')}`}
          >
        ...
        <div className="nav-group">
          ...
          <Link
            ...
            className={`nav-item${isActive('/docs/webhooks/overview')}`}
          >
            Overview
          </Link>
          <Link
            href="/docs/webhooks/event-types"
            className={`nav-item${isActive('/docs/webhooks/event-types')}`}
          >
            Event types
          </Link>
          <Link
            href="/docs/webhooks/signatures"
            className={`nav-item${isActive('/docs/webhooks/signatures')}`}
          >
        ...
        <div className="nav-group">
          ...
          <Link
            ...
            className={`nav-item${isActive('/docs/reference/rate-limits')}`}
          >
            Rate limits
          </Link>
          <Link
            href="/docs/reference/errors"
            className={`nav-item${isActive('/docs/reference/errors')}`}
          >
            Errors
          </Link>
          <Link
            href="/docs/reference/sdks"
            className={`nav-item${isActive('/docs/reference/sdks')}`}
          >
            SDKs & libraries
          </Link>
        </div>

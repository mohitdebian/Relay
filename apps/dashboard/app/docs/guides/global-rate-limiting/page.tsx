    ...
    <>
      <main className="docs-main">
        ...
        <ul className="docs-ul" style={{ paddingLeft: '20px', marginBottom: '14px', fontSize: '15px', color: 'var(--text)', lineHeight: '1.65' }}>
          <li style={{ marginBottom: '6px' }}><strong>Free tier:</strong> 100 req / minute</li>
          <li style={{ marginBottom: '6px' }}><strong>Pro tier:</strong> 1,000 req / minute</li>
          <li style={{ marginBottom: '6px' }}><strong>Enterprise tier:</strong> 10,000 req / minute</li>
        </ul>
        ...
        <ul className="docs-ul" style={{ paddingLeft: '20px', marginBottom: '14px', fontSize: '15px', color: 'var(--text)', lineHeight: '1.65' }}>
          <li style={{ marginBottom: '6px' }}><code className="docs-inline">x-relay-limit-limit</code>: The maximum number of requests permitted in the current time window.</li>
          <li style={{ marginBottom: '6px' }}><code className="docs-inline">x-relay-limit-remaining</code>: The number of requests remaining in the current window.</li>
          <li style={{ marginBottom: '6px' }}><code className="docs-inline">x-relay-limit-reset</code>: The Unix timestamp when the current window expires and limits are reset.</li>
        </ul>
      </main>

      <aside className="docs-side">
        <div className="docs-response-label" style={{ marginTop: '32px' }}>Response Headers Example</div>
        <CodeCard tabs={tabs} />
      </aside>

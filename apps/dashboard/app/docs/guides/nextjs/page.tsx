  ...
  return (
    <>
      <main className="docs-main">
        ...
        <p className="docs-lede">Protect your Next.js API routes with Relay and verify webhooks.</p>

        <h2 className="docs-h2" id="verifying-webhooks">
          Verifying Webhooks
        </h2>
        <p className="docs-p">
          When Relay forwards a request to your API, it includes an{' '}
          <code className="docs-inline">x-relay-signature</code> header. You can verify this
          signature in your Next.js App Router <code className="docs-inline">Route Handlers</code>{' '}
          (e.g., <code className="docs-inline">app/api/webhook/route.ts</code>) using Node.js's
          built-in <code className="docs-inline">crypto.verify</code> method.
        </p>

        <p className="docs-p">
          Below is a complete example of a Next.js App Router webhook endpoint that securely
          validates inbound requests from Relay.
        </p>
        ...
        <ul className="docs-ul">
          ...
          <li>
            Your <strong>Relay Webhook Secret</strong> stored in{' '}
            <code className="docs-inline">process.env.RELAY_WEBHOOK_SECRET</code>.
          </li>
        </ul>
      </main>
      ...
      <DocsToc links={[{ label: 'Verifying Webhooks', href: '#verifying-webhooks' }]} />
    </>
  );
}
